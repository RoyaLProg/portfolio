	...
	return (
		...
		>
			<div className="flex gap-8 flex-col items-center w-full">
				<div id="skilltitle" className="text-(--cyan) leading-none"></div>
				<div className="w-full flex flex-col gap-8">
					...
					<div className="border-2 border-(--gutter-fg-grey) p-2">
						...
						<div className="flex flex-col items-center gap-2 p-2">
							<div className="border-2 text-xs md:text-base w-full md:grid md:grid-cols-4 flex justify-between items-center p-2">
								<p>1. Skill</p>
								<div className="flex">
									<input type="checkbox" />
									<p>percentage</p>
							...
							<div className="border-2 w-full md:grid md:grid-cols-4 flex justify-between items-center p-2 text-xs md:text-base">
								<p>2. Skill</p>
								<div className="flex">
									<input type="checkbox" />
									<p>percentage</p>
